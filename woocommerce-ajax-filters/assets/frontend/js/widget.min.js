...
braapf_filter_mobile_desktop_filters;
...
(function ($){
    ...
    braapf_selected_filters_area_set = function() {
        ...
        if( typeof(braapf_filtered_filters) != 'undefined' ) {
    ...
    bapf_universal_theme_compatibility = function(data) {
        if( berocket_apply_filters('universal_theme_compatibility', true) ) {
            ...
            //Woodmart theme
            try {if( berocket_apply_filters('woodmart_theme_compatibility', (typeof(woodmartThemeModule) == 'object' ) ) ) {
                ...
                if( typeof(woodmartThemeModule.productsLoadMore) == 'function' ) {
...
(function ($){
    ...
    braapf_show_hide_values_save = function(data) {
        ...
        $('.bapf_sfilter').has('.bapf_show_hide').each(function() {
    ...
    braapf_show_hide_values_set = function(data) {
        $.each(braapf_show_hide_values_status.open, function(i, val) {
            var $filter = $('#'+val).has('.bapf_show_hide');
            $filter.removeClass('bapf_fhide');
            $filter.find('.bapf_show_hide').text($filter.find('.bapf_show_hide').data('hide'));
        });
        $.each(braapf_show_hide_values_status.close, function(i, val) {
            var $filter = $('#'+val).has('.bapf_show_hide');
            $filter.addClass('bapf_fhide');
            $filter.find('.bapf_show_hide').text($filter.find('.bapf_show_hide').data('show'));
        });
        return data;
    }
